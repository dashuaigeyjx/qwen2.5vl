...
# For low VRAM GPUs: Set do_offload=True, enforce_eager=True, tensor_parallel_size=1, use_dynamic_bsz=False, and use a small ppo_micro_batch_size_per_gpu.
# For high VRAM GPUs: Set do_offload=False and use_dynamic_bsz=True to speed up training.
# If VLLM generation gets stuck: Try lowering workers_per_tool and reducing gpu_memory_utilization in the script.
# If you encounter CPU OOM issues during VLLM rollout generation: Try setting do_offload=False and lowering gpu_memory_utilization.
set -x
model_name="/home/unnet/project/model/Qwen3-0.6B"
train_data="./data/searchR1_processed_direct_default/train.parquet"
val_data="./data/searchR1_processed_direct_default/test.parquet"
...
#file_path=/root/hzr/FlashRAG-main-0.1.4
#index_file=$file_path/indexes2/e5_Flat.index
#corpus_file=$file_path/test_sample.jsonl
#retriever_name=e5
#retriever_path=/root/hzr/FlashRAG-main-0.1.4/model/e5/
#CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 /root/miniconda3/envs/faiss_env/bin/python ./verl_tool/servers/tools/utils/search_retrieval.py \
