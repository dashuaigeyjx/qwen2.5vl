...
set -x
model_name="/home/unnet/project/model/Qwen2.5-3B-Instruct"
train_data="./data/my/train.parquet"
val_data="./data/my/test.parquet"
...
#additional_eos_token_ids=[151643] # <|end¨xof¨xsentence|> token id
...
python -m verl_tool.servers.serve --host $host --port $port --tool_type "search_retrieval" --workers_per_tool 8 --thread_pool_size 32 &
server_pid=$!
